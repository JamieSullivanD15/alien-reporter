...
var URL = 'http://www.mocky.io/v2/59f7760a2f0000ab1d55864e';
var DataProvider = (function () {
    ...
    DataProvider.prototype.setSightings = function (alienSightings) {
        this.alienSightings = alienSightings;
    };
    DataProvider.prototype.getSightings = function () {
    ...
    DataProvider.prototype.getData = function () {
        ...
        return this.http.get(URL)
            ...
            _this.alienSightings.push(data.json()),
                _this.formatDateAndTime();
        }, function (error) {
            console.log(error);
        });
    };
    DataProvider.prototype.formatDateAndTime = function () {
        var splitDate;
        for (var i = 0; i < this.alienSightings.length; i++) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["c" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_6__app_component__["a" /* MyApp */], {}, {
                links: [
                    { loadChildren: '../pages/sightings/sightings.module#SightingsPageModule', name: 'SightingsPage', segment: 'sightings', priority: 'low', defaultHistory: [] }
                ]
            }),
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\Users\Jamie Sullivan\Documents\GitHub\alien-reporter\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\Jamie Sullivan\Documents\GitHub\alien-reporter\src\app\app.html"*/
    }),
